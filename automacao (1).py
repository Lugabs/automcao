...
Original file is located at
    https://colab.research.google.com/drive/1U5pT7_u_Hg9b6LSEV_0xtP1-HupuqSHC
"""

#Clicar com botão direito > inspecionar > código do botao caminho
...
for page in pages:
  ...
  if response.status_code != 200:
    ...
    #warn(f'O pedido:{Resquests}; retornou o codigo: {response.status_code}')

    page_html = BeautifulSoup(response.test, 'html.parser')
...
#Captura o genero do filme e caso tenha mais de 1, lança na mesma linha separado por virgula (Exemplo: Drama,Romance)
...
#Captura duração do filme, apenas o numero, não traz letras
...
#Captura os votos dos usuarios que esta dentro da tag
...
#Distribui dos dado sem suas respectivas coluna de ano, tratando os anos para que sejam valores numericos passiveis de calculo
